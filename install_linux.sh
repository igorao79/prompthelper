...
install_python_packages() {
    ...
    pip3 install --user requests beautifulsoup4 lxml Pillow numpy certifi urllib3
    
    # Обновляем SSL библиотеки для правильной работы API
    echo "🔒 Обновление SSL библиотек для API..."
    pip3 install --upgrade --user requests urllib3 certifi
